...
public class ItemPickaxeAssembly extends ItemToolAssembly {
    public static final String[] VARIANTS = new String[]{"pickaxe/pickaxe_assembly_iron", "pickaxe/pickaxe_assembly_gold", "pickaxe/pickaxe_assembly_psimetal", "pickaxe/pickaxe_assembly_ebony_psimetal", "pickaxe/pickaxe_assembly_ivory_psimetal", "pickaxe/pickaxe_assembly_creative"};
    public static final String[] MODELS = new String[]{"pickaxe/pickaxe"};
